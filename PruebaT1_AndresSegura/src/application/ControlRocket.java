...
public class ControlRocket {
	...
	@FXML
	private AnchorPane homepage, next;
	@FXML
	...
	public void closeApp() {
		Stage stage1 = (Stage) next.getScene().getWindow();
		stage1.close();
	}

	@FXML
	public void openStage() {
		Stage stage1 = (Stage) homepage.getScene().getWindow();
		stage1.close();
	...
	private void transiccionFoto() {
		FadeTransition ft = new FadeTransition(Duration.seconds(5), imgLogin);
		ft.setFromValue(0);
		ft.setToValue(1);
		ft.play();
	}
